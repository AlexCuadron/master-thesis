...
\begin{itemize}
	...
	% \item \claude{A modular design of the \name Zone Translation Point makes it easy to extend \name with new functionality.}
\end{itemize}

\begin{figure}[t]
\begin{center}
\includegraphics[width=.7\textwidth]{overview.eps}
\end{center}

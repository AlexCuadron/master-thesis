...
\begin{wrapfigure}{r}{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.47\textwidth]{tp_controlflow.png}
        \captionof{figure}{\textit{Control flow of the Zone Translation Point}}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.47\textwidth]{figs/protocol.eps}
\end{center}
\caption{Protocol details for data forwarding. The controller frequently updates \tps 
with the latest zone transfer policies.}
% \ml{Use consistent naming of zones (Z1 vs.\ Zone A; also in main text). Do the ``Zone Transfers'' describe the allowed connections? Where is Z3?}
% \jk{Update figure. We don't use the on-demandzone transfer authorization.}}
\label{fig:protocol}
\end{figure}

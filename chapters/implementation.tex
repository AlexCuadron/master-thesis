...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.47\textwidth]{figs/header.eps}
	\end{center}
	\caption{\name packet format for secure tunneling.}
	% \claude{authentication scope does not cover L3 Header (SCION)}
	\label{fig:header}
\end{figure}
    ...
    \begin{minipage}{.31\linewidth}
    	\caption{Key derivation times for different network sizes (ns).}
         ...
         \begin{tabular}{*4{r}}
			...
			\bottomrule
		\end{tabular}
	% \claude{add updated nubmers to tables}
    \end{minipage}\hspace*{2em}
    \begin{minipage}{.31\linewidth}
      	\centering
...
\begin{figure*}[!htb]
	\begin{minipage}{.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{figs/intra_domain.eps}
		\caption{Processing time for intra-domain zone transfer.}
		\label{fig:intra}
		% \claude{add updated nubmers to graph}
	\end{minipage}\hspace*{1em}
	\begin{minipage}{.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{figs/inter_sender.eps}
		\caption{Processing time on $TP_S$ for inter-domain zone transfer.}
		\label{fig:inter_sender}
	\end{minipage}\hspace*{1em}
	\begin{minipage}{.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{figs/inter_receiver.eps}
